...
<style>
    #zoomC {
        ...
        /* (B) BACKGROUND IMAGE */
        background: url("/Root/Public/img/img2.webp");
...
<head>
    ...
    <link rel="stylesheet" href="\Root\Public\css\pro.css">
    <script src="/Root/Composables/page-1.js"></script>
            ...
            <center>
                <div class="caption">
                    <?php if (!isset($_SESSION['email'])) {  ?>
                        ...
                        ?>
                            <a href="cart_add.php?id=10" class="btn btn-danger" name="add" value="add" class="btn btn-block btr-primary">Add to cart</a>
                    <?php
                        }
                    }
                    ?>
