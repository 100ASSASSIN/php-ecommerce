...
<head>
    ...
    <link rel="stylesheet" href="\Root\Public\css\page-1.css">
...
?>
<a href="cart_add.php?id=3" class="btn btn-danger" name="add" value="add" class="btn btn-block btr-primary">Add to cart</a>
<?php
}
}
?>
