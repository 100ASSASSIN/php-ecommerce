    ...
    <div id="top-row">
        <ul class="nav-links">
            ...
            ?>
                ...
                <li class="center"><a href="index.php"><i class="fas fa-home"></i> HOME</a></li>
                <li class="center"><a href="#"><i class="fab fa-sith"></i> PRODUCT<span></span></a></li>
                <li class="upward"><a href="Public/orders.php"><i class="fab fa-dropbox"></i> Orders<span></span></a></li>
                <li class="upward"><a href="Public/account_admin.php"><i class="fab fa-threads"></i> Account<span></span></a></li>
                <!-- <li><a href="/Public/logout.php"><span></span><i class="fa fa-sign-out" aria-hidden="true"></i>log out</a></li> -->
                <li class="forward"><a href="Public/cart"><i class="fa fa-shopping-cart" aria-hidden="true"></i> CART<span></span></a></li>
            ...
            ?>
                ...
                <li class="center"><a href="index.php"><i class="fas fa-home"></i> HOME</a></li>
                <li class="center"><a href="#"><i class="fab fa-sith"></i> PRODUCT<span></span></a></li>
                <li><a href="Public/signup.php"><span></span><i class="fa fa-user-plus" aria-hidden="true"></i> Sign Up</a></li>
                <li><a href="Public/login.php"><span></span> <i class="fa fa-user-plus" aria-hidden="true"></i> Login</a></li>
                <li><input type="text" name="search" id="search" placeholder="Type to search..." size="30" onkeyup="showResult(this.value)"></li>
            <?php
            }
            ?>
