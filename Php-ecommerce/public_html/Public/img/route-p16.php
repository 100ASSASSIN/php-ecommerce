...
<form method="post" action="addToCart.php">
    <input type="hidden" name="product_id" value="222" /> <!-- Assuming the product ID is 1 for this example -->
